...
namespace I2.Loc
{
    ...
    public class Localize : MonoBehaviour
    {
        ...
        public List<Object>
            TranslatedObjects =
                new List<Object>(); // For targets that reference objects (e.g. AudioSource, UITexture,etc) 
        ...
        public Dictionary<string, Object>
            mAssetDictionary =
                new Dictionary<string, Object>(StringComparer
        ...
        public UnityEvent
            LocalizeEvent =
                new UnityEvent(); // This allows scripts to modify the translations :  e.g. "Player {0} wins"  ->  "Player Red wins"	
        ...
        public EventCallback
            LocalizeCallBack = new EventCallback(); //LocalizeCallBack is deprecated. Please use LocalizeEvent instead.
